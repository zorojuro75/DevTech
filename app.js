users = [{username:"akib",password:"12345", type:"client"}, {username:"banna",password:"12345", type:"manager"}, {username:"ayat",password:"12345", type:"analyst"}, {username:"fahad",password:"12345", type:"developer"}];
...
function login(){
    ...
    for(i=0;i<users.length;i++){
        if(userName==users[i].username && pass==users[i].password){
            ...
            else if(users[i].type=="analyst")document.getElementById('loginForm').action='Analyst/analyst.html';
